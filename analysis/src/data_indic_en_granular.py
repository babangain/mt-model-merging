...
def extract_indic_sentence(src_text: str, lang_code: str) -> str:
    ...
    prefix = f"Translate the following {LANG_MAP[lang_code].title()} sentence to English"
...
def main() -> None:
    ...
    ap.add_argument("--save_dir", type=str, required=True, help="e.g. data_masked_qwen/indic_en")
    ap.add_argument("--languages", type=str, default="hi bn ta te")
    ap.add_argument("--seq_len", type=int, default=1024)
    ap.add_argument("--target_mb", type=int, default=100)
    ap.add_argument("--dataset_pattern", type=str, default="anonymous/flores_{lang}_en_valid")
    args = ap.parse_args()
